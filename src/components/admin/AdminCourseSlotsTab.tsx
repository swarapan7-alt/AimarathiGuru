    ...
    <div className="space-y-3.5">
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-xl sm:rounded-2xl border border-stone-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition shadow-xs cursor-pointer shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        {courseDates.map((cd) => {
          ...
          return (
            <div
              key={cd.id}
              className="bg-white rounded-xl sm:rounded-2xl border border-stone-200 shadow-xs overflow-hidden flex flex-col justify-between"
            >
              {/* Card Header */}
              <div className="px-4 py-2.5 bg-gradient-to-r from-slate-900 to-indigo-950 text-white flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="p-1.5 rounded-lg bg-white/10 text-amber-300">
                    <Calendar className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="font-extrabold text-xs sm:text-sm text-white font-poppins">{cd.displayDate}</h3>
                    <p className="text-[10px] text-slate-300">Date Code: {cd.date}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="p-1 rounded-md bg-white/10 hover:bg-white/20 text-slate-200 transition cursor-pointer"
                    title="Edit Date"
                  >
                  ...
                  <button
                    ...
                    className="p-1 rounded-md bg-red-500/20 hover:bg-red-500/40 text-red-300 transition cursor-pointer"
                    title="Delete Date"
                  >
              ...
              <div className="p-3.5 sm:p-4 space-y-2.5">
                ...
                <div className="p-3 rounded-xl bg-stone-50 border border-stone-200 space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    {isS1Full ? (
                      <span className="px-1.5 py-0.5 rounded-full bg-red-100 text-red-700 text-[9px] font-black uppercase tracking-wider animate-pulse">
                        SLOT FULL
                      </span>
                    ) : (
                      <span className="px-1.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-[9px] font-black uppercase tracking-wider">
