      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-xl sm:rounded-2xl border border-stone-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[10px] font-black uppercase tracking-wider mb-1 font-poppins">
            <ShieldCheck className="w-3 h-3" /> Security & Credentials
          </div>
      ...
      <form onSubmit={handleSave} className="bg-white p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-stone-200 shadow-xs space-y-4">
        ...
        <div className="p-3 rounded-xl bg-stone-50 border border-stone-200 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-[11px] font-extrabold text-slate-900 font-poppins">Current Admin Username</div>
              <div className="text-xs font-mono text-blue-600 font-bold">{currentUsername}</div>
            </div>
          </div>
        ...
        <div className="space-y-1">
          <label className="text-[11px] font-extrabold text-slate-700 block font-poppins">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-xs bg-stone-50 border border-stone-300 rounded-lg outline-none focus:border-blue-600"
          />
        </div>
        ...
        <div className="space-y-1 pt-2 border-t border-stone-200">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-xs bg-stone-50 border border-stone-300 rounded-lg outline-none focus:border-blue-600 font-mono"
          />
        </div>
